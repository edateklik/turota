...
`ai-service`, açıklanabilir content-based önerileri FastAPI üzerinden üretir.
...
ai-service/                      # Python FastAPI öneri motoru
```
...
## FastAPI öneri motoru

`ai-service` Discovery kataloğunu PostgreSQL'den okuyarak TasteProfile kategori/etiket,
beslenme, bütçe ve başlangıç konumu sinyallerini ağırlıklandırır. En uygun mahalleyi seçer,
mekanları skorlar ve kullanılabilir süreye sığan deterministik bir Timeline üretir. Her skor
kullanıcıya gösterilebilir Türkçe nedenlerle açıklanır. Ayrıntılar için
[`ai-service/README.md`](ai-service/README.md) dosyasına bakın.
